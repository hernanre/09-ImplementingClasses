...
class Point(object):
    ...
    def move_to(self, x, y):
        p = Point(x, y)
        hypotenuse = self.get_distance_from(p)
    ...
    def get_distance_from_start(self):
        distance = math.sqrt(((self.x_original - self.x) ** 2) + ((self.y_original - self.y)**2))
        return distance
    ...
    def closer_to(self, p2, p3):
        distance_1 = self.get_distance_from(p2)
        distance_2 = self.get_distance_from(p3)
...
# --------------------------------------------------------------------------
    ...
    p2.move_to(0, 0)
    print()
    print('Expected for p1:SA Point(5, -1)')
    print('Actual for p1:  ', p1)
    print('Expected for p2: Point(0, 0)')
    print('Actual for p2:  ', p2)
